export const EXCEPTIONS_MESSAGES = {
    ...
    VALID_CLASSIFICATION_NUMBER : "The classification must be one of the following numbers (0, 7, 10, 13, 16, 18)"                          ,
    VALID_DURATION : "The duration must have a format hh:mm:ss if it is a movie, if it is a series it must have a valid number of chapters" ,
